...
`trial_core` validation:

- **46,905 rows**
- **46,905 unique `nct_id`s**
- **0 duplicate trials**
...
- `01_cohort_reconciliation.png`
- `02_bridge_row_reconciliation.png`
- `03_recruitment_burden_by_phase.png`
- `04_site_footprint_by_phase.png`
- `05_country_participation_shift.png`
- `06_discontinuation_reasons.png`
- `07_results_posting_coverage.png`

SQL files:

- `00_source_profile.sql`
- `01_trial_core_and_bridges.sql`
